@extends('layouts.app')
@section('title','Buku '.$book->judul_buku)
@push('style')
...
@section('content')
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
            <div class="card-body">
                <h1 class="card-title mb-4">{{ $book->judul_buku }}</h2>
                ...
                <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    ...
                    <div class="d-flex">
                        <p class="text-dark font-weight-semibold mr-2 mb-0 no-wrap">Pengarang :</p>
                        <p class="text-primary mr-1 mb-0">{{ $book->pengarang }}</p>
                    </div>
                    <p class="mb-0 ellipsis">{{ $book->penerbit }}</p>
                    ...
                    <div class="row text-gray d-md-flex d-none">
                        ...
                        <small class="mb-0 mr-2 text-muted text-muted">Tahun Terbit :</small>
                        <small class="Last-responded mr-2 mb-0 text-muted text-muted">{{ $book->tahun_terbit }}</small>
                        </div>
                        <div class="col-4 d-flex">
